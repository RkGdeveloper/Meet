...
public class AdminManagementServiceImpl implements IAdminManagementService{
	...
	@Override
	public int updateDepartmentName(String dName, int deptId) throws EMSException {
		return ied.updateDepartmentName(dName,deptId);
	}
	@Override
	public int updateDesignationName(String desigName, int empId) throws EMSException {
	...
	public String obtaingrade(long salary) {
		String grade=null;
